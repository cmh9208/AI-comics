...
if __name__ == "__main__":
    ...
    parser.add_argument("--result_video", default='asset/result/22.mp4', help="path to output")
    ...
    imageio.v2.mimsave(opt.result_video, [img_as_ubyte(frame) for frame in predictions], fps=fps)

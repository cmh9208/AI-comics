...
os.makedirs("result_train/%s" % dataset_name, exist_ok=True)
os.makedirs("checkpoint_train/%s" % dataset_name, exist_ok=True)
...
def sample_images(batches_done):
    ...
    save_image(image_grid, "result_train/%s/%s.png" % (dataset_name, batches_done), normalize=False)

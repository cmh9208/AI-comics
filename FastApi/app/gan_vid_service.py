...
def create_fake_image(img):
    ...
    checkpoint_G_AB = torch.load("cycle_gan/shinkai/G_AB_19.pth.tar")
...
def face_vid_parser():
    ...
    parser.add_argument("--checkpoint", default='face_vid/00000189-checkpoint.pth.tar',
                        help="path to checkpoint to restore")

    parser.add_argument("--driving_video", default='video_sauce/5.mp4', help="path to driving video")
